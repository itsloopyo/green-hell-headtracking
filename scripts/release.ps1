...
<#
.SYNOPSIS
    Automated release workflow for Green Hell Head Tracking mod.
...
if ($staged) {
    ...
    Write-Host "  No changes to commit (version already set)" -ForegroundColor Gray
}
...
Write-Host "  https://github.com/itsloopyo/green-hell-headtracking/actions" -ForegroundColor Cyan
